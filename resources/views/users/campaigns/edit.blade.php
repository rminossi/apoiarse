    ...
    <section class="dash_content_app">
        ...
        <div class="dash_content_app_box">
            <div class="nav">
                ...
                <form class="app_form" action="{{route('usuario.campanhas.update', ['campanha' => $campaign->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div id="data">
                            ...
                            <div class="label_g3">
                                <label class="label">
                                    ...
                                    <select name="type">
                                        <option {{ $campaign->type == 'sick' ? 'selected' : '' }} value="sick">Doença</option>
                                        <option {{ $campaign->type == 'residential-accident' ? 'selected' : '' }} value="residential-accident">Acidente Residencial</option>
                                        <option {{ $campaign->type == 'public-calamity' ? 'selected' : '' }} value="public-calamity">Calamidade Pública</option>
                                        <option {{ $campaign->type == 'other' ? 'selected' : '' }} value="other">Outro</option>
                                    </select>
                                </label>
                            </div>
                            <div class="label_g2">
                                <label class="label mr-2">
                                    <span class="legend">Meta (R$):</span>
