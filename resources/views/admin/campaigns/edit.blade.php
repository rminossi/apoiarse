                                        ...
                                        <div class="property_image_item">
                                            ...
                                            <div class="property_image_actions">
                                                <a href="javascript:void(0)"
                                                   ...
                                                   data-action="{{ route('admin.campaigns.imageSetCover', ['image' => $image->image->id]) }}"></a>
                                                <a href="javascript:void(0)"
                                                   class="btn btn-red btn-small icon-times icon-notext image-remove"
                                                   data-action="{{ route('admin.campaigns.removeImage', ['image' => $image->image->id]) }}"></a>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
        ...
        $(function () {
            ...
            $('#modality').change(function () {
                if ($(this).val() == 3) {
                    ...
                    $('#fixed-donations').addClass('d-none');
                }
            })
        });
    </script>
